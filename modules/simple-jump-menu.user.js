...
function injectCSS(jq) {
  let css = "<style type='text/css'>" + 
    "#lcsd-jump-toc{display:block;margin-top:0.5em;margin-bottom:0;}" + 
    "#lcsd-jump-container{display:flex;flex-flow:row wrap;justify-content:flex-start; font-family:Lato,sans-serif;flex-wrap:wrap;width:100%;box-sizing:border-box;min-height:64px;padding:0px 9px 0px 9px;}" + 
    ".lcsd-jump-tile{flex-wrap:wrap;width:250px;margin:8px 6px 4px 0px;}" +
    ".lcsd-jump-header{background-color:#f5f5f5;font-weight:700;text-align:left}" + 
    ".lcsd-jump-header{width:100%;border:1px solid #C7CDD1;margin:0;padding:0px;position:relative;box-sizing:border-box}" + 
    ".lcsd-jump-moduletitle{color:#3d454c;width:calc(100% - 16px);text-overflow:ellipsis;overflow:hidden;white-space:nowrap;padding:2px 4px 2px 4px;font-weight:400;}" + 
    ".lcsd-jump-tile a{color:#3d454c;text-decoration:none}" + ".lcsd-jump-moduletitle::before{content:'▌ ';padding-right:4px;color:gray;}" + 
    ".lcsd-jump-moduleitem{margin:2px 8px 4px 8px;text-overflow:ellipsis;font-style:italic;overflow:hidden;width:85%;white-space:nowrap;color:#3d454c;opacity:0.5;font-size:0.8em;line-height:1.0em;}" + 
    ".lcsd-jump-top{width:100%;text-align:right;}"+
    ".lcsd-jump-top a{color:#3d454c;}" + 
    "#lcsd-jump-toc input[type='checkbox'] {vertical-align:1px; transform:scale(1.2,1.2);}" + "#lcsd-jump-toc label{font-size: 1.1em; color: #999999;}"+
    "</style>";
  jq('head').append(css);
}
